...
export default function AdminDashboard() {
  const { data: tenants, isLoading: tenantsLoading } = trpcProvider.tenants.getAll.useQuery()
  const { data: stats } = trpcProvider.dashboard.getStats.useQuery()
          ...
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-warning/10 rounded-lg flex items-center justify-center">
                <SimplePesoIcon className="w-6 h-6 text-warning" />
              </div>
            </div>
          </CardBody>
        </Card>
