...
import { PESO_SYMBOL } from '@/src/lib/utils/currency'
...
export default function NewLoanPage() {
  ...
  const getPaymentFrequencyOptions = () => {
    ...
    if (loanTypeDefaults?.available_payment_frequencies) {
      const availableOptions = loanTypeDefaults.available_payment_frequencies.map((freq: string) => {
        switch (freq) {
          case 'weekly':
                ...
                <CardBody className="p-4">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {previewSchedule.map((payment: any) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium">
                    {paymentFrequencyOptions.find((opt: typeof paymentFrequencyOptions[number]) => opt.key === paymentFrequency)?.label || paymentFrequency}
                  </p>
                </div>
                <div>
