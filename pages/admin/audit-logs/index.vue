...
const fetchLogs = async () => {
  ...
  try {
    ...
    const { data } = await useFetch('/api/tenant/audit-logs', {
      method: 'GET',
      query: queryParams,
    })
...
<template>
  <div class="audit-logs-page">
    <div class="page-header">
      <h1>Organization Audit Logs</h1>
      <p class="subtitle">Activity trail for your organization</p>
    </div>
    ...
    <div class="filters-section">
      <div class="filters-grid">
        <div class="filter-field">
          ...
          <input
            ...
            type="text"
            placeholder="e.g., loan.submitted, user.created"
      ...
      <button class="clear-filters-button" @click="filters = { action: '', entity: '', userId: '', dateFrom: '', dateTo: '' }; handleFilterChange()">
        Clear Filters
      </button>
    </div>
