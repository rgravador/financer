...
export const usePenaltiesStore = defineStore('penalties', {
  actions: {
     ...
     */
    calculatePenalty (dueAmount: number, dueDate: string | Date, currentDate: Date = new Date()): number {
    ...
    calculateTotalPenalties (
      ...
      for (const payment of payments) {
        const penalty = this.calculatePenalty(payment.amount, payment.dueDate, currentDate)
