...
import type { LoanType, PaymentFrequency } from '@/server/db/database'
                  ...
                  <TableRow key={loanType.id}>
                    ...
                    <TableCell>
                      <div className="flex flex-wrap gap-1">
                        {loanType.payment_frequencies.map((freq) => (
                          <Chip
                            key={freq}
                            size="sm"
                            variant="flat"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Input
                      ...
                      onValueChange={(value) => setFormData(prev => ({ ...prev, min_amount: Number(value) || 0 }))}
                      size="lg"
                    ...
                    <Input
                      ...
                      onValueChange={(value) => setFormData(prev => ({ ...prev, max_amount: Number(value) || 0 }))}
                      size="lg"
                      startContent={<SimplePesoIcon className="w-4 h-4 text-default-400" />}
                      isRequired
                    />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Input
                      ...
                      onValueChange={(value) => setFormData(prev => ({ ...prev, min_tenure_months: Number(value) || 1 }))}
                      size="lg"
                      isRequired
                    />
                    ...
                    <Input
                      ...
                      onValueChange={(value) => setFormData(prev => ({ ...prev, max_tenure_months: Number(value) || 12 }))}
                      size="lg"
                      isRequired
                    />
                  </div>
                  ...
                  <Input
                    ...
                    onValueChange={(value) => setFormData(prev => ({ ...prev, interest_rate: Number(value) || 0 }))}
                    size="lg"
                    isRequired
                  />
                    ...
                    <div className="space-y-3">
                      {paymentFrequencyOptions.map((option) => (
                        ...
                        className="ml-2"
                          ...
                          onValueChange={(checked) => handleFrequencyChange(option.key as PaymentFrequency, checked)}
                        >
                          {option.label}
                        </Checkbox>
                      ))}
